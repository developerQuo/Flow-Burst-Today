# Android WebView 전환 대안 모음

본 문서는 `.agent/instructions/android-webview-plan.md`에서 **선택하지 않은 대안**을 모아 둔 참고 문서다.
